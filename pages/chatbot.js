    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const formattedText = `
                ...
                Cantidad de ventas del producto: ${textData || 'No disponibles'}
            `;
            ...
            setError('Error al enviar el mensaje 3: ' + error.message);
        }
    };
